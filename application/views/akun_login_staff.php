...
<div class="container">
    <div class="row">
      <div class="col-md-6 offset-md-3">
        <div class="card my-5">
          <form action="<?=site_url('staff/login_staff')?>" method="post" class="card-body cardbody-color p-lg-5">
            ...
            <div class="mb-3">
              <input type="text" class="form-control" name="id_staff" aria-describedby="emailHelp"
                placeholder="Username">
            </div>
            <div class="mb-3">
              <input type="password" class="form-control" name="password_staff" placeholder="password">
            </div>
