...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
		...
		<div class="card">
            <div class="card-body">
              <h5 class="card-title">Isi Data pelapor</h5>

              <!-- General Form Elements -->
              <form action="<?=site_url('admin/add_pelapor_go')?>" method="post">
  		
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Pelapor</label>
                  <div class="col-sm-10">
                    <input name="nama_pelapor" type="text" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="nomor_telpon" type="text" class="form-control">
                  </div>
                </div>
